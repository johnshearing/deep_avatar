...
PROMPTS["DEFAULT_ENTITY_TYPES"] = [
    ...
    "health_protocol is an entity with an entity_type of category which describes a widely agreed upon method for achieving a health related outcome.",
    "molecule is an entity with an entity_type of category which describes arrangements of atoms often in the context of chemistry, biology, or biophysics.",
    ...
    "cell is an entity with an entity_type of category which describes the basic membrane-bound unit that contains the fundamental molecules of life.",
    ...
    "well_being is an entity with an entity_type of category which describes the result of one's physical, mental, and emotional admittance to the flow of God's endless blessings or endless choices, which may be indicated by health and prosperity, but is always indicated by a sense of love, peace and joy.",
