...
class MergeGUI:
    def __init__(self, root):
        ...
        ttk.Label(header_frame, text="Select Entities", font=("TkDefaultFont", 9, "bold")).pack(side="left")
        ttk.Label(header_frame, text="First Entity", font=("TkDefaultFont", 9, "bold")).pack(side="right")
        ...
        for ent in self.entity_list:
            ...
            rb = ttk.Radiobutton(ent_frame, text="First", variable=self.first_entity_var, value=ent)
            rb.pack(side="right")
