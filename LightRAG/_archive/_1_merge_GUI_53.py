...
class MergeGUI:
    ...
    def create_left_panel(self):
        ...
        # Removed select_all_button, keeping select_all_entities logic
    ...
    def create_entity_list(self):
        ...
        # Pagination settings
        page_size = 100  # Display 100 entities per page
        current_page = getattr(self, 'current_page', 0)  # Track current page
        start_idx = current_page * page_size
        end_idx = start_idx + page_size
        
        # Slice the filtered entity list
    ...
    def change_page(self, direction):
        max_pages = (len(self.filtered_entity_list) + 99) // 100  # Calculate total pages
