...
class MergeGUI:
    ...
    def create_left_panel(self):
        ...
        self.select_all_orphans_button.grid(row=0, column=2, sticky="ew", padx=(2, 2))
    ...
    def update_button_visibility(self):
        ...
        # Check for merge and delete button visibility
        ...
        # Check for create relationship button visibility
    ...
    def open_create_relationship_modal(self):
        ...
        modal.grid_columnconfigure(0, weight=1)
        modal.grid_rowconfigure(5, weight=1)
        ...
        source_combobox.grid(row=1, column=1, sticky="ew", padx=10, pady=2)

        ttk.Label(modal, text="Target Entity:").grid(row=2, column=0, sticky="w", padx=10, pady=2)
        ...
        target_combobox.grid(row=2, column=1, sticky="ew", padx=10, pady=2)

        # Description
        ttk.Label(modal, text="Relationship Description:").grid(row=3, column=0, sticky="w", padx=10, pady=2)
        ...
        desc_text.grid(row=3, column=1, sticky="nsew", padx=10, pady=2)
        desc_scrollbar.grid(row=3, column=2, sticky="ns")

        # Keywords
        ttk.Label(modal, text="Keywords (comma-separated):").grid(row=4, column=0, sticky="w", padx=10, pady=2)
        keywords_entry = ttk.Entry(modal)
        keywords_entry.grid(row=4, column=1, sticky="ew", padx=10, pady=2)

        # Weight
        ttk.Label(modal, text="Weight (1.0-10.0):").grid(row=5, column=0, sticky="w", padx=10, pady=2)
        weight_var = tk.StringVar(value="1.0")
        weight_entry = ttk.Entry(modal, textvariable=weight_var)
        weight_entry.grid(row=5, column=1, sticky="ew", padx=10, pady=2)

        # Source File ID
        ttk.Label(modal, text="Source File ID:").grid(row=6, column=0, sticky="w", padx=10, pady=2)
        source_file_id_entry = ttk.Entry(modal)
        source_file_id_entry.grid(row=6, column=1, sticky="ew", padx=10, pady=2)
