...
class MergeGUI:
    ...
    def create_left_panel(self):
        ...
        ttk.Label(pagination_frame, text="Go to page:").grid(row=0, column=5, padx=(10, 2))
        self.page_entry = ttk.Entry(pagination_frame, width=5)
        self.page_entry.grid(row=0, column=6, padx=2)
        ttk.Button(pagination_frame, text="Go", command=self.jump_to_page).grid(row=0, column=7, padx=2)
