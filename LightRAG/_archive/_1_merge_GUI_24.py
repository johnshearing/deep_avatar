...
class MergeGUI:
    ...
    def create_left_panel(self):
        ...
        action_buttons_frame.grid_columnconfigure(3, weight=1) # Added for new button
        ...
        # New button: Select All Of Entity Type
        ...
        self.clear_all_button.grid(row=0, column=3, sticky="ew", padx=(2, 0)) # Moved to column 3
    ...
    def select_all_of_entity_type(self):
        ...
        self.filter_var.set("")
        # Optionally, you could set filtered_entity_list to only show these,
        # but the request implies just checking them off in the main list.
        # For simplicity, we just refresh the full list view.
        self.filtered_entity_list = self.entity_list.copy() 
