...
class MergeGUI:
    ...
    def update_button_visibility(self):
        ...
        # Check if the currently displayed filtered list exactly matches the set of selected entities
        # and if the displayed list is not empty
        if selected_from_all and set(self.filtered_entity_list) == selected_from_all and len(self.filtered_entity_list) == len(selected_from_all):
            self.merge_button.grid() # Show
            self.delete_button.grid() # Show
        else:
            self.merge_button.grid_remove() # Hide
            self.delete_button.grid_remove() # Hide
