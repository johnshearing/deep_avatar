...
async def main():
    ...
    try:
        ...
        if not index_exists:
            # Process PDF file
            print(f"Checking PDF at: {PDF_FILE_PATH}")
        ...
        response = await rag.aquery(
            query = "What is the name of the file from which the text originates? Please use only information found in the text to answer.",
